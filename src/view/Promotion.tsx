...
const Promotion = () => {
  return (
    <section className="">
        ...
        <div className="flex justify-center font-bold text-blue-600 md:text-sm text-[10px] pt-16 ">
          PROMOTIONS
        </div>
        <div className="flex justify-center font-bold md:text-3xl pt-3 pb-8 text-25px">
